...
class FairRankingTask(object):
        ...
        with open(input_file, 'r') as f_in:
            for line in f_in:
                ...
                for rel_data in query_data['documents']:
                    groundtruth_data[query_data['qid']][rel_data['doc_id']] = rel_data['relevance']
        #print(groundtruth_data[5438])
    ...
    def groups_exposure(self, seq_id, submission, gamma):
        ...
        for q_num, q_id in self.sequence[seq_id]:
            #print('q_num: ' + str(q_num) + ' qid: ' + str(q_id))
            stopped_until_now = 1.
...
if __name__ == '__main__':
    ...
    run_files = [
        ...
        'dispImKL_r0_g50_c50.jsonl',
        'dispImKL_r25_g25_c50.jsonl',
        'dispImKL_r25_g50_c25.jsonl',
        'dispImKL_r34_g33_c33.jsonl',
        'dispImKL_r40_g30_c30.jsonl',
        'dispImKL_r50_g0_c50.jsonl',
        'dispImKL_r50_g25_c25.jsonl',
        'dispImKL_r60_g20_c20.jsonl',
        'dispImKL_r80_g10_c10.jsonl',
        'bm25.jsonl',
        'random.jsonl',
    ]
